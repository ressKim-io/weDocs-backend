...
class EmitterRequiredAttributesPropertyTest {
    ...
    void emittedEvent_containsEventName_traceId_andAllRequiredAttributes(
            @ForAll("taxonomyWithAttributes") Tuple.Tuple2<DocLogEvent, Map<String, String>> input) {

        DocLogEvent taxonomy = input.get1();
    ...
    @Provide
    Arbitrary<Tuple.Tuple2<DocLogEvent, Map<String, String>>> taxonomyWithAttributes() {
        Arbitrary<DocLogEvent> taxonomyArb = Arbitraries.of(DocLogEvent.values());
